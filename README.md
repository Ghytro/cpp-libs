...
## Matrix
This is a class for matrices. The class includes such basic operations as matrices addition, multiplying on a constant and multyplying the matrices, counting the determinant and finding the inverse matrix, the minor and cofactor matrices of a matrix
